...
namespace TagExtract.Repository
{
    ...
    partial void InsertTagUrl(TagUrl instance);
    partial void UpdateTagUrl(TagUrl instance);
    partial void DeleteTagUrl(TagUrl instance);
    #endregion
		...
		public System.Data.Linq.Table<TagUrl> TagUrl
		{
			get
			{
				return this.GetTable<TagUrl>();
			}
		}
	}
    ...
    partial void OnFilePathChanged();
		...
		[Association(Name="FK_SourceFileTag_SourceFile", Storage="_SourceFileTag", OtherKey="FileId", DeleteRule="NO ACTION")]
	...
	public partial class SourceFileTag : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<TagUrl> _TagUrl;
    ...
    partial void OnTagChanged();
		...
		public SourceFileTag()
		{
			...
			this._TagUrl = default(EntityRef<TagUrl>);
			OnCreated();
		}
		...
		[Association(Name="FK_SourceFileTag_SourceFile", Storage="_SourceFile", ThisKey="FileId", IsForeignKey=true)]
		...
		[Association(Name="FK_TagBinary_SourceFileTag", Storage="_TagBinary", ThisKey="TagId", IsUnique=true, IsForeignKey=false, DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_TagFullText_SourceFileTag", Storage="_TagFullText", ThisKey="TagId", IsUnique=true, IsForeignKey=false, DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_TagPicture_SourceFileTag", Storage="_TagPicture", ThisKey="TagId", IsUnique=true, IsForeignKey=false, DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_TagText_SourceFileTag", Storage="_TagText", ThisKey="TagId", IsUnique=true, IsForeignKey=false, DeleteRule="NO ACTION")]
		...
		[Association(Name="FK_TagUrl_SourceFileTag", Storage="_TagUrl", ThisKey="TagId", IsUnique=true, IsForeignKey=false, DeleteRule="NO ACTION")]
		public TagUrl TagUrl
		{
			get
			{
				return this._TagUrl.Entity;
			}
			set
			{
				TagUrl previousValue = this._TagUrl.Entity;
				if (((previousValue != value) 
							|| (this._TagUrl.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._TagUrl.Entity = null;
						previousValue.SourceFileTag = null;
					}
					this._TagUrl.Entity = value;
					if ((value != null))
					{
						value.SourceFileTag = this;
					}
    ...
    partial void OnBinaryObjectChanged();
		...
		[Association(Name="FK_TagBinary_SourceFileTag", Storage="_SourceFileTag", ThisKey="TagId", IsForeignKey=true)]
    ...
    partial void OnCommentChanged();
		...
		[Association(Name="FK_TagFullText_SourceFileTag", Storage="_SourceFileTag", ThisKey="TagId", IsForeignKey=true)]
		public SourceFileTag SourceFileTag
		{
			get
			{
    ...
    partial void OnBinaryImageChanged();
		...
		[Association(Name="FK_TagPicture_SourceFileTag", Storage="_SourceFileTag", ThisKey="TagId", IsForeignKey=true)]
		public SourceFileTag SourceFileTag
		{
			get
			{
    ...
    partial void OnTextChanged();
		...
		[Association(Name="FK_TagText_SourceFileTag", Storage="_SourceFileTag", ThisKey="TagId", IsForeignKey=true)]
		public SourceFileTag SourceFileTag
		{
			get
			{
	...
	[Table()]
	public partial class TagUrl : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnUrlChanged();
		...
		[Association(Name="FK_TagUrl_SourceFileTag", Storage="_SourceFileTag", ThisKey="TagId", IsForeignKey=true)]
		public SourceFileTag SourceFileTag
		{
			get
			{
