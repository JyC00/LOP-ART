...
namespace TagEditor
{
	...
	public class ID3PowerEdit : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this._treeView.Location = new System.Drawing.Point(8, 8);
            this._treeView.Name = "_treeView";
            this._treeView.Size = new System.Drawing.Size(552, 344);
		...
		private void ID3PowerEdit_Load(object sender, System.EventArgs e)
		{
			...
			{
				TreeNode node = null;
				if(_hash.Contains(frameBase.Tag))
				{
					node = (TreeNode)_hash[frameBase.Tag];
				}
				else
				{
					node = new TreeNode(frameBase.TagDescription);
					_hash.Add(frameBase.Tag,node);
