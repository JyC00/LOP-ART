...
namespace WaveletLibrary
{
    ...
    public abstract class BaseLift
    {
        ...
        ///  second half.
        /// </summary>
        public void Split(WaveletMatrix data, int N)
        {
        ...
        ///  of length N.
        /// </summary>
        public void Merge(WaveletMatrix data, int N)
        {
        ...
        /// </summary>
        public abstract void Predict(WaveletMatrix data, int N, bool direction);

        /// <summary>
        /// Update step, to be defined by the subclass 
        /// </summary>
        public abstract void Update(WaveletMatrix data, int N, bool direction);
        ...
        /// </summary>
        public virtual void ForwardTrans(WaveletMatrix data, int level)
        {
        ...
        ///  in-place and the result is returned in the argument array.
        /// </summary>
        public virtual void InverseTrans(WaveletMatrix data, int level)
        {
            int N = data.GetSelecedVectorLength();
